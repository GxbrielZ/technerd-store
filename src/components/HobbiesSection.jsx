...
const HobbiesSection = ({ hobbies, headerTitle }) => {
    ...
    <div className="bg-darkwhite mt-4 py-6 px-4 relative shadow">
      ...
      <div ref={sliderRef} className="keen-slider">
        {hobbies.map((category) => (
          ...
          >
            <div className="w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 rounded-full flex items-center justify-center mb-2 overflow-hidden">
              {category.image ? (
                <img
                  src={category.image}
                  alt={category.name}
